...
struct K {
    ...
    static let article11URL = Bundle.main.url(forResource: "article11", withExtension: "html")?.path
    static let article12URL = Bundle.main.url(forResource: "article12", withExtension: "html")?.path
    static let article21URL = Bundle.main.url(forResource: "article21", withExtension: "html")?.path
    static let article22URL = Bundle.main.url(forResource: "article22", withExtension: "html")?.path
    static let article23URL = Bundle.main.url(forResource: "article23", withExtension: "html")?.path
    static let article24URL = Bundle.main.url(forResource: "article24", withExtension: "html")?.path
